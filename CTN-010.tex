...
\newcommand{\lsstcam}{{\it LSSTCam}}
\newcommand{\lsst}{{\it LSST}}
\graphicspath{{figures/}}
\newcommand{\docRef}{CTN-010}
\newcommand{\docUpstreamLocation}{\url{https://github.com/lsst/ctn-010}}
...
\input{authors}
\date{\today}
\title{Tree Rings in LSSTCam CCDs}

% This can write metadata into the PDF.
% Update keywords and author information as necessary.
\hypersetup{
    pdftitle={Tree Rings in LSSTCam CCDs},
    pdfauthor={plazasa},
    pdfkeywords={}
}
